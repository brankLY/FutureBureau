  ...
  static async betTransfer(stub, params) {
    ...
    try {
      ...
      const transferTokenRequest = {
        ...
        description: 'sample code test transfer to contract account',
      };
      logger.debug('%s - transferTokenRequest is %j BETTokenTransferRequest is %s ', method, JSON.stringify(transferTokenRequest), BETTokenTransferRequest.account);
