...
class UserHandler {
  ...
  static async transferBack(i, user, len, futureBureau, rate) {
    let transferTokenRequest = {
    ...
    const temp = transferTokenRequest;
    transferTokenRequest = temp;
  ...
  static async settle(stub, params) {
    ...
    try {
      ...
      logger.debug('rate is %s ', rate);
      this.transferBack(i, user, len, futureBureau, rate);
