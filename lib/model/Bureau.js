...
class Bureau {
  ...
  // }
  toJSONFu(futureBureau) {
    return {
      name: futureBureau.name,
      creator: futureBureau.creator,
      content: futureBureau.content,
      createTime: futureBureau.createTime,
      endTime: futureBureau.endTime,
      option1: futureBureau.option1,
      option2: futureBureau.option2,
      option3: futureBureau.option3,
      option4: futureBureau.option4,
      option5: futureBureau.option5,
      judgePerson: futureBureau.judgePerson,
      history: futureBureau.history,
      result: futureBureau.result,
      users: futureBureau.users,
      count1: futureBureau.count1,
      count2: futureBureau.count2,
      count3: futureBureau.count3,
      count4: futureBureau.count4,
      count5: futureBureau.count5,
    };
  }
  toJSON() {
    const res = {};
    Object.entries(this.futureBureaus).forEach(([name, futureBureau]) => {
      res[name] = this.toJSONFu(futureBureau);
