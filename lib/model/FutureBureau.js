...
class FutureBureau {
  ...
  static async Create(stub, options) {
    ...
    futureBureaus.bureaus.push(options.name);
    futureBureaus.creators.push(id);
    futureBureaus.judgePersons.push(options.judgePerson);
    futureBureaus.endTimes.push(options.endTime);
