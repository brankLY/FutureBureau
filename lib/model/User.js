...
class User {
  ...
  static Mix_User(stub, user, account) {
    const newuser = new User(stub);
    newuser.id = user.id;
    newuser.name = user.name;
    newuser.role = user.role;
    newuser.canCreateNewFutureBureau = user.canCreateNewFutureBureau;
    newuser.bureau = user.bureau;
    newuser.canCreateNewToken = account.canCreateNewToken;
    newuser.wallet = account.wallet;
    return newuser;
  }
